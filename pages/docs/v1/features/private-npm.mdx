...
If you want to forward your [npm](https://npmjs.com/) credentials every time you create a new deployment using <ProductShortV1Name />, you can set the `forwardNpm` property inside your global `~/.vercel.json` file to `true`:
