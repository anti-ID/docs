...
In some cases, you may prefer to build on Travis CI instead of directly on <ProductShortV1Name />. If that's the case, this can be achieved by modifying your `.travis.yml` and `vercel.json` files a little bit.
